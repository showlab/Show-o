...
class ImageNetDataset(DatasetFolder):
    ...
    def __init__(self,
        ...
        with open('./datasets/imagenet_label_mapping', 'r') as f:
            self.labels = {}
            for l in f:
    ...
    def __getitem__(self, idx: int) -> Optional[Dict[str, Any]]:
        try:
            ...
            text = "{}".format(self.labels[target])
...
def create_imagenet_dataloader(train_shards_path_or_url: str,
                                batch_size: int,
                                text_tokenizer: Any,
    ...
    dataset = ImageNetDataset(train_shards_path_or_url,
...
def example():
    ...
    loader = create_imagenet_dataloader(
    ...
    loader2 = create_imagenet_dataloader(
        "/mnt/bn/vgfm2/test_dit/imagenet/ILSVRC/Data/CLS-LOC/train",
        text_tokenizer=text_tokenizer,
        batch_size=2,
        max_seq_len=1024,
